...
export const equivalent_to = (tree1, tree2) => {
    ...
    while (walk_1_state.length && walk_2_state.length) {
        ...
        if (node_1 === null) {
            if (node_2 === null) continue;
            return false;
        }

        if (node_2 === null) {
            if (node_1 === null) continue;
            return false;
        }
        ...
        if (
            walk_1_state.length
            && walk_2_state.length
            && walk_1_state[walk_1_state.length - 1]
            && walk_2_state[walk_2_state.length - 1]
        ) {
            walk_1_state.push(null);
            walk_2_state.push(null);
        }
    }
