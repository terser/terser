...
import {NOPE, World, LiteralType, FunctionType, sequential, Return, hoist_defun_decls} from "./tools.js";
...
AST_Call.prototype._flow = function (world = new World()) {
    ...
    try {
        ...
        for (; i < func_type.node.argnames.length; i++) {
            ...
            callee_world.define(func_type.node.argnames[i].name, arg_type);
        }
