...
export function is_basic_identifier_string(str) {
...
export function get_full_char_code(str, pos) {
...
export function get_full_char_length(str) {
    var surrogates = 0;
...
export function from_char_code(code) {
...
export function is_surrogate_pair_head(code) {
    return code >= 0xd800 && code <= 0xdbff;
}

export function is_surrogate_pair_tail(code) {
...
export function is_identifier_start_broad(ch) {
    return UNICODE_BROAD.ID_Start.test(ch);
}

/** supports a "wider" range of identifiers -- as unicode evolves, new characters are accepted */
export function is_identifier_char_broad(ch) {
    return UNICODE_BROAD.ID_Continue.test(ch);
}

export function is_identifier_string(str, allow_surrogates) {
